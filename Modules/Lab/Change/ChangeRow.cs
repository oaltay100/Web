...
namespace LBYS.Lab
{
    [ConnectionKey("Default"), Module("Lab"), TableName("[dbo].[Change]")]
    [DisplayName("Change"), InstanceName("Change")]
    [ReadPermission("?")]
    [ModifyPermission("?")]
    public sealed class ChangeRow : BaseRow<ChangeRow.RowFields>, IIdRow, INameRow
    {
        ...
        public ChangeRow(RowFields fields)
            : base(fields)
        {
        }
