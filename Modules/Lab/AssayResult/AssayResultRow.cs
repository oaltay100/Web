...
namespace LBYS.Lab
{
    [ConnectionKey("Default"), Module("Lab"), TableName("[dbo].[AssayResult]")]
    [DisplayName("Assay Result"), InstanceName("Assay Result")]
    [ReadPermission("?")]
    [ModifyPermission("?")]
    public sealed class AssayResultRow : Row<AssayResultRow.RowFields>, IIdRow
    {
        ...
        public AssayResultRow()
            : base()
        {
        }

        public AssayResultRow(RowFields fields)
            : base(fields)
        {
        }
