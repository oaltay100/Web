...
namespace LBYS.Lab
{
    [ConnectionKey("Default"), Module("Lab"), TableName("[dbo].[Panel]")]
    [DisplayName("Panel"), InstanceName("Panel")]
    [ReadPermission("?")]
    [ModifyPermission("?")]
    public sealed class PanelRow : BaseRow<PanelRow.RowFields>, IIdRow, INameRow
    {
        ...
        public PanelRow(RowFields fields)
            : base(fields)
        {
        }
