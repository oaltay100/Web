...
namespace LBYS.Lab
{
    [ConnectionKey("Default"), Module("Lab"), TableName("[dbo].[Report]")]
    [DisplayName("Report"), InstanceName("Report")]
    [ReadPermission("?")]
    [ModifyPermission("?")]
    public sealed class ReportRow : BaseRow<ReportRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Report"), Size(100), NotNull, QuickSearch, NameProperty]
        public String Report
        {
            get => fields.Report[this];
        ...
        public ReportRow(RowFields fields)
            : base(fields)
        {
        }
